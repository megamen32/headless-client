...
const (
	...
	chromeConnFlowIncrement = 15663105
)
...
func (t *Transport) newClientConn(c net.Conn, singleUse bool, internalStateHook func()) (*ClientConn, error) {
	...
	maxHeaderTableSize := uint32(chromeHeaderTableSize)
	...
	cc.initialStreamRecvWindowSize = chromeInitialWindowSize
	...
	cc.fr.WriteWindowUpdate(0, chromeConnFlowIncrement)
	cc.inflow.init(chromeConnFlowIncrement + initialWindowSize)
	cc.bw.Flush()
	if cc.werr != nil {
		cc.Close()
		return nil, cc.werr
