...
import (
	...
	"github.com/megamen32/headless-client/internal/dtls/internal/closer"
	...
	dtlsflight12 "github.com/megamen32/headless-client/internal/dtls/internal/flight/flight12"
	dtlsflight13 "github.com/megamen32/headless-client/internal/dtls/internal/flight/flight13"
	dtlsfragmentbuffer "github.com/megamen32/headless-client/internal/dtls/internal/fragmentbuffer"
	dtlshandshake "github.com/megamen32/headless-client/internal/dtls/internal/handshake"
	"github.com/megamen32/headless-client/internal/dtls/internal/negotiation"
	dtlsrrc "github.com/megamen32/headless-client/internal/dtls/internal/rrc"
...
func (c *Conn) prepareHandshakeRecords(outbound *dtlsflight.Outbound, dtlsHandshake *handshake.Handshake) ([]preparedRecord, error) {
	recordOverhead, err := c.handshakeRecordOverhead(outbound.Epoch, outbound.Protection)
	if err != nil {
		return nil, err
	}
...
func (c *Conn) handshakeRecordOverhead(epoch uint16, protection dtlsflight.Protection) (int, error) {
	...
	if common.CipherSuite == nil {
		return 0, dtlserrors.ErrCipherSuiteNotInit
	}
	if _, err := c.writeTrafficGeneration(epoch); err != nil {
		return 0, err
	}
	protectedLen, err := common.CipherSuite.Capabilities().ProtectedLen(innerPlaintextContentTypeLen)
	if err != nil {
		return 0, err
	}
	...
	return len(marshalled) + protectedLen, nil
}
